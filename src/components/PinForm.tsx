  ...
  return (
    <>
      ...
      >
        ...
        {imageUrl && (
          <button
            className="active:scale-[0.98] transition duration-150 mt-4 bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full flex justify-center"
            type="submit"
          >
